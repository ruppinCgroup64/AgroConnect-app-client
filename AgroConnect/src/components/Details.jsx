import {
  ...
  export default function Details(props) {
    const { consumer, setConsumer, setNavContinue } = props;
    ...
    const [firstName, setFirstName] = useState(() => consumer && consumer.firstName ? consumer.firstName : "");
    const [lastName, setLastName] = useState(() => consumer && consumer.lastName ? consumer.lastName : "");
    const [dateOfBirth, setDateOfBirth] = useState(() => consumer && consumer.dateOfBirth ? consumer.dateOfBirth : "");
    const [gender, setGender] = useState(() => consumer && consumer.gender ? consumer.gender : "");
    const [email, setEmail] = useState(() => consumer && consumer.email ? consumer.email : "");
    const [phoneNum, setPhoneNum] = useState(() => consumer && consumer.phoneNum ? consumer.phoneNum : "");
    const [address, setAddress] = useState(() => consumer && consumer.address ? consumer.address : "");
    const [password, setPassword] = useState(() => consumer && consumer.password ? consumer.password : "");
    const [confirmPassword, setConfirmPassword] = useState(() => consumer && consumer.confirmPassword ? consumer.confirmPassword : "");
    const [profilePic, setProfilePic] = useState(() => consumer && consumer.profilePic ? consumer.profilePic : "");
    const [isFarmer, setIsFarmer] = useState(() => consumer && consumer.isFarmer ? consumer.isFarmer : false);
