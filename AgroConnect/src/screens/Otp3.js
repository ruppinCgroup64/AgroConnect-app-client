            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                <View style={[style.main, { backgroundColor: theme.bg, marginTop: 15 }]}>
                    <AppBar
                        ...
                        leading={<TouchableOpacity onPress={() => navigation.navigate('TopUpMethod')}>
                            <Icon name="arrow-back" color={theme.txt} size={30} />
                        </TouchableOpacity>
                        } />

                    <Text style={[style.r18, { color: theme.txt, textAlign: 'center', marginTop: 20, }]}>Enter your PIN to top up</Text>
                    ...
                    <View style={{
                        ...
                        <View style={[style.modalcontainer, { backgroundColor: theme.bg2, width: width - 40, marginVertical: 140 }]}>
                            <View style={{ marginTop: 5, marginHorizontal: 20 }}>
                                ...
                                <Text style={[style.apptitle, { color: theme.txt, textAlign: 'center', }]}>Top up Successful!</Text>
                                <Text style={[style.r16, { color: theme.txt, textAlign: 'center', marginTop: 5, }]}>You have successfully top up e-wallet for $100</Text>
                                <TouchableOpacity onPress={() => {setVisible(false),navigation.navigate('Ticket')}}
                                    style={[style.btn, { marginTop: 20 }]}>
                                    <Text style={[style.btntxt, {}]}>View E-Receipt</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => {setVisible(false),navigation.navigate('MyTabs')}}
